...
public class Nplus1ProblemWithSolution {
	...
	//3. Using JOIN FETCH (here we have used as named query
	
	
	
	//2. Using Hint and Entity Graph
	@Test
	@Transactional
	...
	@Test
	@Transactional
	public void NplusOne_solution_JOIN_FETCH(){
		
		List<Course> courses = em.createNamedQuery("query_get_all_courses_with_students_join_fetch",Course.class).getResultList();
